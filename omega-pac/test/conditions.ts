...
const lolex: any = require('lolex');
import Conditions from '../src/conditions';
const U2: any = require('uglify-js');

describe('Conditions', () => {
  function testCond(condition: any, request: any, should_match?: any): boolean {
    ...
    let testFunc = new U2.AST_Function({
      argnames: [
    ...
    const compileResult = testFunc(request.url, request.host, request.scheme);

    function friendlyError(compiled?: string) {
  ...
  describe('FalseCondition', () => {
    it('should always return false', () => {
      testCond({ conditionType: 'FalseCondition' }, {}, !('match'));
    });
  });
  ...
  describe('UrlRegexCondition', () => {
    ...
    it('should not match requests not matching the pattern', () => {
      testCond(cond, 'http://www.example.net/', !('match'));
    });
  ...
  describe('UrlWildcardCondition', () => {
    ...
    it('should not support regex meta chars', () => {
      ...
      testCond(c, 'http://example.com/', !('match'));
    });
    it('should support multiple patterns in one condition', () => {
      ...
      testCond(c, 'http://c.example.org/ghi', !('match'));
    });
  });
  ...
  describe('HostWildcardCondition', () => {
    ...
    it('should process patterns like *.*example.com correctly', () => {
      ...
      testCond(con, 'http://xample.com/', !('match'));
    });
  ...
  describe('BypassCondition', () => {
    ...
    it('should match the port specified in the pattern', () => {
      ...
      testCond(cond, 'http://example.com:888/', !('match'));
    });
    it('should correctly support patterns using IPv4 literals', () => {
      ...
      testCond(cond, 'http://127.0.0.2:8080/', !('match'));
    });
    it('should correctly support IPv6 canonicalization', () => {
      ...
      testCond(cond, 'http://[1::1]:8080/', !('match'));
    });
  ...
  describe('IpCondition', () => {
    ...
    // runner, which is not available in the unit test. So We can't use testCond here.
    ...
    it('should not pass domain name to isInNet function', () => {
      function ipToCompiledFunc(ip: string, prefixLen: number) {
        const cond = {
          conditionType: 'IpCondition',
          ip: ip,
  ...
  describe('KeywordCondition', () => {
    ...
    it('should not match HTTPS requests', () => {
      testCond(cond, 'https://example.com/', !('match'));
      testCond(cond, 'https://example.net/', !('match'));
    });
  });
  ...
  describe('WeekdayCondition', () => {
    ...
    function testCondDay(cond: any, day: number, match: any) {
  ...
  describe('TimeCondition', () => {
    ...
    function testCondTime(cond: any, time: string, match: any) {
    ...
    it('should match requests based on hour range', () => {
      ...
      testCondTime(cond, '23:00:00', !('match'));
    });
  ...
  describe('#str and #fromStr', () => {
    ...
    it('should provide sensible fallbacks for invalid IpCondition (negative prefixLength)', () => {
